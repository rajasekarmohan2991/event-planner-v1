...
export function CompanyLogoUploadSelf() {
    ...
    async function handleFileSelect(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            const updateRes = await fetch(`/api/company/logo`, {
                method: 'PATCH',
            ...
            if (!updateRes.ok) {
                ...
                throw new Error(errorData.details || errorData.error || 'Failed to update company logo');
            }
