        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <motion.button
                    ...
                    className="flex items-center justify-center p-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all duration-200 disabled:opacity-50"
