...
const MODULE_ACCESS: Record<string, string[]> = {
  '/dashboard': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'FINANCE_ADMIN', 'MARKETING_ADMIN', 'SUPPORT_STAFF', 'STAFF', 'ADMIN', 'EXHIBITOR_MANAGER', 'VIEWER', 'USER'],
  '/events': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'FINANCE_ADMIN', 'MARKETING_ADMIN', 'SUPPORT_STAFF', 'STAFF', 'ADMIN', 'EXHIBITOR_MANAGER', 'ATTENDEE', 'VIEWER'],
  '/registrations': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'FINANCE_ADMIN', 'MARKETING_ADMIN', 'SUPPORT_STAFF', 'STAFF', 'ADMIN', 'ATTENDEE', 'VIEWER'],
  '/exhibitors': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'EXHIBITOR_MANAGER', 'SUPPORT_STAFF', 'STAFF', 'ADMIN', 'VIEWER'],
  '/design': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'MARKETING_ADMIN', 'EXHIBITOR_MANAGER', 'STAFF', 'ADMIN'],
  '/communicate': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'MARKETING_ADMIN', 'EXHIBITOR_MANAGER', 'STAFF', 'ADMIN'],
  '/reports': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'FINANCE_ADMIN', 'MARKETING_ADMIN', 'EXHIBITOR_MANAGER', 'STAFF', 'ADMIN', 'VIEWER'],
  '/eventday': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'SUPPORT_STAFF', 'STAFF', 'ADMIN'],
  '/venues': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'STAFF', 'ADMIN'],
  '/settings': ['SUPER_ADMIN', 'TENANT_ADMIN', 'EVENT_MANAGER', 'VENUE_MANAGER', 'FINANCE_ADMIN', 'MARKETING_ADMIN', 'ADMIN'],
}
