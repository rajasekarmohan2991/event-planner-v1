// Dynamic import of sendEmail to avoid bundling nodemailer in client components
...
<body>
  <div class="invoice-container">
    ...
    <!-- Footer -->
    <div class="footer">
      ${data.isSigned && data.signatureUrl ? `
        <div style="margin-bottom: 20px;">
            <img src="${data.signatureUrl}" style="max-height: 80px; width: auto; display: inline-block;" alt="Authorized Signature" />
            <p style="margin-top: 5px; font-weight: bold;">Authorized Signature</p>
        </div>
      ` : `
