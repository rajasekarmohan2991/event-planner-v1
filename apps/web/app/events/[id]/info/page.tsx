...
export default function EventInfoPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <header className="sticky top-20 z-60 bg-white/95 backdrop-blur-sm shadow-sm rounded-lg px-4 py-3 flex flex-col md:flex-row gap-4 md:items-center md:justify-between mb-2">
