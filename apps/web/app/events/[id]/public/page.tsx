        ...
        <div className="space-y-6">
          <div className="rounded-xl overflow-hidden border bg-white">
            ...
            <div className="p-5 space-y-2">
              ...
              <div className="pt-3">
                <Link href={`/events/${id}/register`} className="inline-flex items-center gap-2 rounded-md px-4 py-2 text-white text-sm hover:opacity-90" style={{ background: site?.colors?.primary || '#4f46e5' }}>
