...
const BOOTH_TYPES = ['Standard', 'Premium', 'Island', 'Corner', 'Inline', 'Peninsula', 'Custom']
...
export default function AddCompanyExhibitorPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                toast({ title: 'Exhibitor added successfully!' })
                router.push('/admin/service-management/exhibitors')
            } else {
                const data = await res.json()
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Add an exhibitor to one of your events
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card className="border-2 border-dashed border-green-300 bg-green-50/50">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Choose which event this exhibitor is associated with
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
