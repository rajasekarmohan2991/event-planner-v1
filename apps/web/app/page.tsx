...
export default function HomePage() {
  ...
  return (
    <main className="relative overflow-hidden min-h-[calc(100vh-4rem)] bg-gradient-to-br from-rose-50 via-white to-pink-50">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Link href="/auth/register" className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-rose-600 to-pink-600 px-5 py-3 text-white text-sm font-medium shadow-sm hover:shadow transition-shadow">
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-16 md:pb-24">
        <div className="grid md:grid-cols-3 gap-5">
          <div className="rounded-lg border bg-white p-5 hover:shadow-sm transition-shadow">
            <div className="inline-flex items-center justify-center h-9 w-9 rounded-md bg-rose-50 text-rose-600 mb-3"><Users className="h-4 w-4" /></div>
          ...
          <div className="rounded-lg border bg-white p-5 hover:shadow-sm transition-shadow">
            <div className="inline-flex items-center justify-center h-9 w-9 rounded-md bg-rose-50 text-rose-600 mb-3"><Calendar className="h-4 w-4" /></div>
          ...
          <div className="rounded-lg border bg-white p-5 hover:shadow-sm transition-shadow">
            <div className="inline-flex items-center justify-center h-9 w-9 rounded-md bg-rose-50 text-rose-600 mb-3"><Sparkles className="h-4 w-4" /></div>
